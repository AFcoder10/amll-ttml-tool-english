...
You can also use the Tauri desktop builds generated by GitHub Actions. See [GitHub Actions Tauri build](https://github.com/Steve-xmh/amll-ttml-tool/actions/workflows/build-test.yaml).
