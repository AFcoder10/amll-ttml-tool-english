...
You can use the online version at [`https://steve-xmh.github.io/amll-ttml-tool/`](https://steve-xmh.github.io/amll-ttml-tool/).

You can also use the Tauri desktop builds generated by GitHub Actions. See [GitHub Actions Tauri build](https://github.com/streetlegithub/amll-ttml-tool-english/actions/workflows/build-test.yaml).
