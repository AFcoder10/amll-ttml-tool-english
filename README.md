...
The build can be a bit involved. If the text below feels lengthy, you can follow the steps in the [`build-desktop.yaml`](.github/workflows/build-desktop.yaml) workflow as a reference.
